...
# This must be done before any other modules that make network requests are imported.
...
if __name__ == "__main__":
    ...
    """
    # 1. Apply the logging configuration first to capture all startup messages.
    setup_loggers()
    ...
    # 2. Initialize the database to ensure tables are created before the bot needs them.
    initialize_database()
